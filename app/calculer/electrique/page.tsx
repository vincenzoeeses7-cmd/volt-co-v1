...
export default function CalculsElectriquesPage() {
  return (
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-8">
          ...
          <p className="mt-3 text-volt-white/70">
            Tous les calculs électriques disponibles dans VOLT & CO.
          </p>
        </div>
        ...
        <section className="mt-10 grid gap-5 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-2 text-sm text-volt-white/60">
              Calculer l&apos;intensité du courant à partir de la charge et
              du temps.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mt-2 text-sm text-volt-white/60">
              Calculer la résistance selon la résistivité, la longueur et la
              section.
            </p>
          </Link>
        </section>
