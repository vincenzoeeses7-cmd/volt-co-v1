...
import { calculateParallelResistance } from "@/lib/calculations/electrical";

export default function ParallelePage() {
  ...
  function calculateResult() {
    ...
    try {
      const total = calculateParallelResistance(values);
      setResult(total);
    } catch (error) {
      setError(
    ...
    <main className="min-h-screen px-6 py-10">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-6 inline-flex rounded-xl border border-volt-blue/20 bg-volt-blue-dark p-1">
          <Link
            href="/calculer/resistances/serie"
