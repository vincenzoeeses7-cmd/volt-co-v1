...
export default function ChuteDeTensionFormulePage() {
  return (
        ...
        <div className="mt-5 grid gap-5 sm:grid-cols-2">
          <section className="rounded-2xl border border-volt-blue/20 bg-volt-blue-dark p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm text-volt-white/70">
              <li><strong className="text-volt-white">ΔU</strong> = chute de tension en volts (V)</li>
          ...
          <section className="rounded-2xl border border-volt-blue/20 bg-volt-blue-dark p-6">
            ...
            <div className="mt-4 space-y-3">
              <div className="rounded-xl border border-volt-blue/10 bg-background p-4 text-center">
                <p className="font-semibold text-volt-blue">R = ΔU ÷ I</p>
              </div>

              <div className="rounded-xl border border-volt-blue/10 bg-background p-4 text-center">
                <p className="font-semibold text-volt-blue">I = ΔU ÷ R</p>
              </div>
            </div>
          </section>
        </div>
